...
export default function Page() {
  ...
  return (
    <div id="main_container">
      ...
      <h2>NexGear MC15</h2>
      <div>Medium Voltage, Metal Clad Switchgear, 15kV 1,200A</div>
      ...
      >
        ...
        <tbody>
          {lineup1_table &&
            lineup1_table
              .filter(
                (lineup1) => lineup1.lineup1_name.toLowerCase().includes(search) || lineup1.lineup1_bo.toString().toLowerCase().includes(search)
              )
              .map((lineup1, index) => (
                <tr key={lineup1.lineup1_id}>
                  {/* <td
                    style={{
                      margin: "0",
                      padding: "0",
                  ...
                  >
                    <span title={"ID:" + lineup1.lineup1_id}>
                      <Link href={links.lineups + "/" + lineup1.lineup1_id}>{lineup1.lineup1_name}</Link>
                    </span>
                  </td>
                  <td>{new Date(lineup1.lineup1_opened_date).toLocaleDateString()}</td>
                  <td style={{}}>{lineup1.lineup1_bo}</td>
                  <td>{Array.from(lineup1.first_name)[0] + "." + lineup1.last_name}</td>
                  <td>
                    {lineup1.lineup1_enclosure == "NEMA1" && (
                      <span
                        style={{
                    ...
                    {lineup1.lineup1_enclosure == "NEMA3R" && (
                      <span
                        style={{
                    ...
                    {lineup1.lineup1_enclosure == "NEMA3RW" && "Walk-in"}
                  </td>
                  <td style={{ textAlign: "right", padding: "0 2rem 0 0 " }}>{lineup1.lineup1_amount && Dollar(lineup1.lineup1_amount)}</td>
